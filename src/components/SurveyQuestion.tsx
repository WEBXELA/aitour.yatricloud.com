      ...
      >
        <div className="max-w-xl w-full">
          ...
          <motion.div
            ...
            className="gradient-border bg-white p-1 shadow-lg"
          >
            <QuestionInput
              question={question}
              value={value}
          ...
          >
            {!isFirstQuestion && (
              <button
                onClick={onBack}
                className="group flex items-center gap-2 px-8 py-3 bg-white text-gray-700 rounded-lg transition-all duration-300 hover:bg-gray-50 shadow-md"
              >
            ...
            <button
              onClick={onSubmit}
              disabled={isDisabled()}
              className={`group relative flex items-center gap-2 px-8 py-3 bg-[#0a66c2] text-white rounded-lg transition-all duration-300 ml-auto
                ${isDisabled() 
